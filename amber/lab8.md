...
3. Налаштувати **Grafana** для моніторингу використання ресурсів віртуальних машин з попередніх лабораторних робіт:
 ...
 4. Використовуючи [k6](https://k6.io/) зробити нагрузку на веб сервери і відобразити результати в **Grafana**
 5. Відключити один з веб серверів повторити навантаження з допомогою **k6** і відобразити зміни в **Grafana**
